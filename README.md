...
- **Frameworks/Libraries:** Spring Core,SpringBoot,Flask, Node.js, Express,langchain, React, PyTorch, TensorFlow, Rasa, Socket.IO, SBERT, Chart.js/other charting libs, O‑Llama, ROS  
